                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <div class="grid grid-cols lg:grid-cols-3 md:grid-cols-2 gap-4">
                                                @forelse ($thumbnail_service as $thumbnail_item)
                                                    <div class="mb-2">
                                                        <img src="{{ url(Storage::url($thumbnail_item->thumbnail)) }}" alt="thumbnail" class="inline object-cover w-20 h-20 rounded-full" for="choose">

                                                        <input placeholder="Thumbnail" type="file" name="{{ 'thumbnails['.$thumbnail_item->id.']' }}" id="thumbnails" autocomplete="thumbnails" class="w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                                    </div>
                                                @empty
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @forelse ($tagline as $tagline_item)
                                                <input placeholder="Keunggulan 1" type="text" name="{{ ('taglines['.$tagline_item->id.']') }}" id="taglines" autocomplete="taglines" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $tagline_item->tagline ?? '' }}" required>
                                            @empty
                                                {{-- empty --}}
                                            @endforelse
