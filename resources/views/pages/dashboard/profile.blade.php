                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="your contact number" type="number" name="contact_number" id="contact_number" autocomplete="contact_number" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" style="-moz-appearance: textfield; -webkit-appearance: none; appearance: none;" value="{{ $user->detail_user->contact_number ?? '' }}" required>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @forelse ($experience_user as $key => $item)
                                                ...
                                                @if ($errors->has('experience['.$item->id.']'))
                                                    <p class="text-red-500 mb-3 text-sm">
                                                        {{ $errors->first('experience['.$item->id.']') }}
                                                    </p>
                                                @endif
                                            @empty
