...
class ProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        $experience_user = ExperienceUser::where('detail_user', $user->detail_user->id)
                                        ->orderBy('id', 'asc')
                                        ->get();
