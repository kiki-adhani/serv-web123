<a href="<?php echo e(route('detail.landing', 1)); ?>" class="block">
    <div class="w-auto h-auto overflow-hidden md:p-5 p-4 bg-white rounded-2xl inline-block">
        ...
        <img class="rounded-2xl w-full"
            src="<?php echo e(url('https://via.placeholder.com/750x500')); ?>" alt="placeholder" />
...
</a><?php /**PATH C:\xampp\htdocs\bwa-jasa\resources\views/components/landing/service-explore.blade.php ENDPATH**/ ?>