            ...
            <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
                ...
                <div class="col-span-4 text-right">
                    <div @click.away="open = false" class="relative z-10 hidden mt-5 lg:block" x-data="{ open: false }">
                        ...
                        <img class="inline w-12 h-12 mr-3 rounded-full" src="<?php echo e(url('https://randomuser.me/api/portraits/men/1.jpg')); ?>" alt="">
            ...
            <div class="grid gap-5 md:grid-cols-12">
                <main class="p-4 lg:col-span-7 md:col-span-12 md:pt-0">
                    <div class="sm:grid sm:h-32 sm:grid-flow-row sm:gap-4 sm:grid-cols-3">
                        <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                            <div>
                                <div>
                                    <img src="<?php echo e(asset('/assets/images/services-progress-icon.svg')); ?>" alt="" class="w-8 h-8">
                                </div>
                        ...
                        <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                            <div>
                                <div>
                                    <img src="<?php echo e(asset('/assets/images/services-completed-icon.svg')); ?>" alt="" class="w-8 h-8">
                                </div>
                        ...
                        <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                            <div>
                                <div>
                                    <img src="<?php echo e(asset('/assets/images/new-freelancer-icon.svg')); ?>" alt="" class="w-8 h-8">
                                </div>
                                <p class="mt-2 text-2xl font-semibold text-left text-gray-800">3</p>
                                <p class="text-sm text-left text-gray-500">
                            ...
                            <tbody class="bg-white">
                                <tr class="text-gray-700">
                                    <td class="w-1/3 px-1 py-5">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded-full" src="<?php echo e(url('https://randomuser.me/api/portraits/men/2.jpg')); ?>" alt="" loading="lazy" />
                                    ...
                                    <td class="w-2/4 px-1 py-5">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded" src="<?php echo e(url('https://randomuser.me/api/portraits/men/3.jpg')); ?>" alt="" loading="lazy" />
                                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                            </div>
                                            <div>
                                ...
                                <tr class="text-gray-700">
                                    <td class="w-1/3 px-1 py-5">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded-full" src="<?php echo e(url('https://randomuser.me/api/portraits/men/4.jpg')); ?>" alt="" loading="lazy" />
                                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                            </div>
                                            <div>
                                    ...
                                    <td class="w-2/4 px-1 py-5">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded" src="<?php echo e(url('https://randomuser.me/api/portraits/men/5.jpg')); ?>" alt="" loading="lazy" />
                                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                            </div>
                                            <div>
                                                <p class="font-medium text-black">
                                ...
                                <tr class="text-gray-700">
                                    <td class="w-1/3 px-1 py-5">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded-full" src="<?php echo e(url('https://randomuser.me/api/portraits/men/6.jpg')); ?>" alt="" loading="lazy" />
                                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                            </div>
                                            <div>
                                    ...
                                    <td class="w-2/4 px-1 py-5">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded" src="<?php echo e(url('https://randomuser.me/api/portraits/men/7.jpg')); ?>" alt="" loading="lazy" />
                                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                            </div>
                                            <div>
                                                <p class="font-medium text-black">
                ...
                <aside class="p-4 lg:col-span-5 md:col-span-12 md:pt-0">
                    <div class="relative w-full h-56 m-auto text-white transition-transform transform bg-red-100 rounded-xl">
                        ...
                        <img class="relative object-cover w-full h-full rounded-xl" src="<?php echo e(asset('/assets/images/card-background.png')); ?>" alt="">
                        ...
                        <div class="absolute w-full px-8 top-8">
                            <div class="flex justify-between">
                                ...
                                <img class="w-16 h-12" src="<?php echo e(asset('/assets/images/visa-icon.svg')); ?>" alt="" />
                            </div>
                            <div class="pt-6">
                            ...
                            <tbody class="bg-white">
                                ...
                                <tr class="text-gray-700">
                                    <td class="w-1/2 px-1 py-2">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded-full" src="<?php echo e(url('https://randomuser.me/api/portraits/men/3.jpg')); ?>" alt="" loading="lazy" />
                                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                            </div>
                                            <div>
                                                <p class="font-medium text-black">Sarah Roses</p>
                                ...
                                <tr class="text-gray-700">
                                    <td class="w-1/2 px-1 py-2">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded-full" src="<?php echo e(url('https://randomuser.me/api/portraits/men/5.jpg')); ?>" alt="" loading="lazy" />
                                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                            </div>
                                            <div>
                                                <p class="font-medium text-black">Sarah Roses</p>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bwa-jasa\resources\views/pages/dashboard/index.blade.php ENDPATH**/ ?>