            ...
            <div class="mx-auto flex pt-16 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 px-8 lg:flex-row flex-col">
                ...
                <div class="w-full lg:w-1/2 text-center lg:justify-start justify-center flex pr-0">
                    <img class="bottom-0 lg:block lg:right-24 md:right-16 sm:right-8 right-8 w-75"
                        src="<?php echo e(asset('/assets/hero-image.png')); ?>" alt="" />
                </div>
            </div>
            <div class="lg:mb-20 mb-10 flex sm:space-x-4 space-x-1">
                <div class="flex-1 flex items-center justify-center py-3 px-6">
                    <img src="<?php echo e(url('images/brand-logo/netflix.svg')); ?>" alt="">
                </div>
                <div class="flex-1 flex items-center justify-center py-3 px-6">
                    <img src="<?php echo e(url('images/brand-logo/amazon.svg')); ?>" alt="">
                </div>
                <div class="flex-1 flex items-center justify-center py-3 px-6">
                    <img src="<?php echo e(url('images/brand-logo/uber.svg')); ?>" alt="">
                </div>
                <div class="flex-1 flex items-center justify-center py-3 px-6">
                    <img src="<?php echo e(url('images/brand-logo/grab.svg')); ?>" alt="">
                </div>
                <div class="flex-1 flex items-center justify-center py-3 px-6">
                    <img src="<?php echo e(url('images/brand-logo/google.svg')); ?>" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="pt-16 pb-16 lg:pb-20 lg:pl-24 md:pl-16 sm:pl-8 pl-8 mx-auto">
                ...
                <div class="flex overflow-x-scroll pb-10 hide-scroll-bar dragscroll -mx-3">
                    <div class="flex flex-nowrap">
                        <?php echo $__env->make('components.landing.service', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
        ...
        <div class="py-10 lg:py-24 flex lg:flex-row flex-col items-center cta-bg">
            ...
            <div class="w-full lg:w-1/2 text-center justify-center flex lg:mb-0 mb-12">
                <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" data-lity>
                    <img id="hero" src="<?php echo e(asset('/assets/images/video-placeholder.png')); ?>" alt="" class="p-5" />
                </a>
            </div>
            <!-- Right Column -->
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bwa-jasa\resources\views/pages/landing/index.blade.php ENDPATH**/ ?>