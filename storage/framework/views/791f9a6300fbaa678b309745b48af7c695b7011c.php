...
<?php $__env->startSection('title', ' Submit Order'); ?>
                    ...
                    <div class="px-6 py-2 mt-2 bg-white rounded-xl">
                        ...
                        <div class="flex p-8 border border-gray-200 rounded-lg bg-serv-upload-bg h-128">
                            <div class="m-auto text-center">
                                <img src="<?php echo e(asset('/assets/images/services-file-icon.svg')); ?>" alt="" class="w-20 mx-auto">
                                <h2 class="mt-8 mb-1 text-2xl font-semibold text-gray-700">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bwa-jasa\resources\views/pages/dashboard/order/edit.blade.php ENDPATH**/ ?>