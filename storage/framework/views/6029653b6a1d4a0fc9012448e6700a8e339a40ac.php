        ...
        <div class="grid gap-5 md:grid-cols-12">
            <main class="p-4 lg:col-span-8 md:col-span-12">
                ...
                <div class="details-heading">
                    ...
                    <div class="my-3">
                        <?php echo $__env->make('components.landing.rating', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
                <div class="p-3 my-4 bg-gray-100 rounded-lg image-gallery" x-data="gallery()">
                    ...
                    <div class="flex overflow-x-scroll hide-scroll-bar dragscroll">
                        <div class="flex mt-2 flex-nowrap">
                            <img :class="{'border-4 border-serv-button': active === 1}" @click="changeThumbnail('https://source.unsplash.com/_SgRNwAVNKw/1600x900/',1)" 
                            src="<?php echo e(url('https://source.unsplash.com/_SgRNwAVNKw/250x160/')); ?>" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                            <img :class="{'border-4 border-serv-button': active === 2}" @click="changeThumbnail('https://source.unsplash.com/GXNo-OJynTQ/1600x900/',2)" 
                            src="<?php echo e(url('https://source.unsplash.com/GXNo-OJynTQ/250x160/')); ?>" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                            <img :class="{'border-4 border-serv-button': active === 3}" @click="changeThumbnail('https://source.unsplash.com/x-HpilsdKEk/1600x900/',3)" 
                            src="<?php echo e(url('https://source.unsplash.com/x-HpilsdKEk/250x160/')); ?>" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                            <img :class="{'border-4 border-serv-button': active === 4}" @click="changeThumbnail('https://source.unsplash.com/hLit2zL-Dhk/1600x900/',4)" 
                            src="<?php echo e(url('https://source.unsplash.com/hLit2zL-Dhk/250x160/')); ?>" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                            <img :class="{'border-4 border-serv-button': active === 5}" @click="changeThumbnail('https://source.unsplash.com/i1VQZsU86ok/1600x900/',5)" 
                            src="<?php echo e(url('https://source.unsplash.com/i1VQZsU86ok/250x160/')); ?>" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                            <img :class="{'border-4 border-serv-button': active === 6}" @click="changeThumbnail('https://source.unsplash.com/iEiUITs149M/1600x900/',6)" 
                            src="<?php echo e(url('https://source.unsplash.com/iEiUITs149M/250x160/')); ?>" alt="" class="inline-block mr-2 rounded-lg cursor-pointer w-36">
                        </div>
                    </div>
                </div>
                <div class="content">
                    <div x-data="{ tab: window.location.hash ? window.location.hash.substring(1) : 'description' }" id="tab_wrapper">
                            ...
                            <div class="grid md:grid-cols-12">
                                <div class="flex items-center col-span-12 p-2 lg:col-span-6">
                                    <div class="flex items-center space-x-4">
                                        <img src="<?php echo e(url('https://avatars2.githubusercontent.com/u/1490347?s=460&u=39d7a6b9bc030244e2c509119e5f64eabb2b1727&v=4')); ?>" alt="My profile" class="w-20 h-20 rounded-full ">
                                    </div>
                        ...
                        <div x-show.transition.duration.500ms="tab === 'reviews'">
                            ...
                            <?php echo $__env->make('components.landing.review', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php echo $__env->make('components.landing.review', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            <?php echo $__env->make('components.landing.review', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
            ...
            <aside class="p-4 lg:col-span-4 md:col-span-12 md:pt-0">
                <div class="mb-4 border rounded-lg border-serv-testimonial-border">
                    ...
                    <div class="flex items-start px-4 pt-6">
                        <img class="object-cover w-16 h-16 mr-4 rounded-full" src="<?php echo e(url('https://images.unsplash.com/photo-1542156822-6924d1a71ace?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60')); ?>" alt="avatar">
                        <div class="w-full">
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bwa-jasa\resources\views/pages/landing/detail.blade.php ENDPATH**/ ?>