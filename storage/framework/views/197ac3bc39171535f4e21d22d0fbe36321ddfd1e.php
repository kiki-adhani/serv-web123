                ...
                <div class="relative p-6 flex-auto mx-10">
                    <div class="mb-4">
                        ...
                        <?php if($errors->has('name')): ?>
                            <p class="text-red-500 mb-3 text-sm"><?php echo e($errors->first('name')); ?></p>
                        <?php endif; ?>
                    </div>
                    ...
                    <div>
                        ...
                        <?php if($errors->has('password')): ?>
                            <p class="text-red-500 mb-3 text-sm"><?php echo e($errors->first('password')); ?></p>
                        <?php endif; ?>
                    </div>
                    ...
                    <div>
                        ...
                        <?php if($errors->has('password_confirmation')): ?>
                            <p class="text-red-500 mb-3 text-sm"><?php echo e($errors->first('password_confirmation')); ?></p>
                        <?php endif; ?>
                    </div>
...
<div class="hidden opacity-75 fixed inset-0 z-40 bg-black" id="registerModal-backdrop"></div><?php /**PATH C:\xampp\htdocs\bwa-jasa\resources\views/components/modal/register.blade.php ENDPATH**/ ?>