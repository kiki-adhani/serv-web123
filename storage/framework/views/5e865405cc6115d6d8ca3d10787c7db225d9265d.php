                            ...
                            <div class="grid gap-5 md:grid-cols-12">
                                <main class="p-4 lg:col-span-7 md:col-span-12">
                                    ...
                                    <div class="details-heading">
                                        ...
                                        <div class="my-3">
                                            <?php echo $__env->make('components.dashboard.rating', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                        </div>
                                    </div>
                                    <div class="p-3 my-4 bg-gray-100 rounded-lg image-gallery" x-data="gallery()">
                                        ...
                                        <div class="flex overflow-x-scroll hide-scroll-bar dragscroll">
                                            <div class="flex mt-2 flex-nowrap">
                                                <img :class="{'border-4 border-serv-button': active === 1}" @click="changeThumbnail('https://source.unsplash.com/_SgRNwAVNKw/1600x900/',1)" src="<?php echo e(url('https://source.unsplash.com/_SgRNwAVNKw/250x160/')); ?>" alt="" class="inline-block w-24 mr-2 rounded-lg cursor-pointer">
                                                <img :class="{'border-4 border-serv-button': active === 2}" @click="changeThumbnail('https://source.unsplash.com/GXNo-OJynTQ/1600x900/',2)" src="<?php echo e(url('https://source.unsplash.com/GXNo-OJynTQ/250x160/')); ?>" alt="" class="inline-block w-24 mr-2 rounded-lg cursor-pointer">
                                                <img :class="{'border-4 border-serv-button': active === 3}" @click="changeThumbnail('https://source.unsplash.com/x-HpilsdKEk/1600x900/',3)" src="<?php echo e(url('https://source.unsplash.com/x-HpilsdKEk/250x160/')); ?>" alt="" class="inline-block w-24 mr-2 rounded-lg cursor-pointer">
                                                <img :class="{'border-4 border-serv-button': active === 4}" @click="changeThumbnail('https://source.unsplash.com/hLit2zL-Dhk/1600x900/',4)" src="<?php echo e(url('https://source.unsplash.com/hLit2zL-Dhk/250x160/')); ?>" alt="" class="inline-block w-24 mr-2 rounded-lg cursor-pointer">
                                                <img :class="{'border-4 border-serv-button': active === 5}" @click="changeThumbnail('https://source.unsplash.com/i1VQZsU86ok/1600x900/',5)" src="<?php echo e(url('https://source.unsplash.com/i1VQZsU86ok/250x160/')); ?>" alt="" class="inline-block w-24 mr-2 rounded-lg cursor-pointer">
                                                <img :class="{'border-4 border-serv-button': active === 6}" @click="changeThumbnail('https://source.unsplash.com/iEiUITs149M/1600x900/',6)" src="<?php echo e(url('https://source.unsplash.com/iEiUITs149M/250x160/')); ?>" alt="" class="inline-block w-24 mr-2 rounded-lg cursor-pointer">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="content">
                                ...
                                <div class="p-4 md:text-right lg:col-span-6 md:col-span-12">
                                    ...
                                    <a href="<?php echo e(route('member.service.edit', 1)); ?>" class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white border border-transparent rounded-lg shadow-sm bg-serv-email hover:bg-serv-email-text focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-serv-email">
                                        Edit Service
                                    </a>
                                </div>
                            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bwa-jasa\resources\views/pages/dashboard/order/detail.blade.php ENDPATH**/ ?>