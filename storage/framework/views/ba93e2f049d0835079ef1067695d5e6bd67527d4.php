            ...
            <div class="grid gap-5 md:grid-cols-12">
                <main class="col-span-12 p-4 md:pt-0">
                    <div class="px-2 py-2 mt-2 bg-white rounded-xl">
                        <form action="<?php echo e(route('member.service.store')); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Service apa yang ingin kamu tawarkan?" type="text" name="title" id="title" autocomplete="title" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="<?php echo e(old('title')); ?>" required>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Jelaskan Service apa yang kamu tawarkan?" type="text" name="description" id="description" autocomplete="description" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="<?php echo e(old('description')); ?>" required>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Keunggulan Service 1" type="text" name="advantage-service[]" id="advantage-service" autocomplete="advantage-service" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="<?php echo e(old('advantage-service[]')); ?>" required>
                                            <input placeholder="Keunggulan Service 2" type="text" name="advantage-service[]" id="advantage-service" autocomplete="advantage-service" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="<?php echo e(old('advantage-service[]')); ?>" required>
                                            <input placeholder="Keunggulan Service 3" type="text" name="advantage-service[]" id="advantage-service" autocomplete="advantage-service" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="<?php echo e(old('advantage-service[]')); ?>" required>
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <?php if($errors->has('revision_limit')): ?>
                                                <p class="text-red-500 mb-3 text-sm">
                                                    <?php echo e($errors->first('revision_limit')); ?>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Total Harga Service Kamu" type="number" name="price" id="price" autocomplete="price" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="<?php echo e(old('price')); ?>" required>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Keunggulan Kamu 1" type="text" name="advantage-user[]" id="advantage-user" autocomplete="advantage-user" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="<?php echo e(old('advantage-user[]')); ?>" required>
                                            <input placeholder="Keunggulan Kamu 2" type="text" name="advantage-user[]" id="advantage-user" autocomplete="advantage-user" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="<?php echo e(old('advantage-user[]')); ?>" required>
                                            <input placeholder="Keunggulan Kamu 3" type="text" name="advantage-user[]" id="advantage-user" autocomplete="advantage-user" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="<?php echo e(old('advantage-user[]')); ?>" required>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Hal yang ingin disampaikan oleh kamu?" type="text" name="note" id="note" autocomplete="note" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="<?php echo e(old('note')); ?>">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bwa-jasa\resources\views/pages/dashboard/service/create.blade.php ENDPATH**/ ?>