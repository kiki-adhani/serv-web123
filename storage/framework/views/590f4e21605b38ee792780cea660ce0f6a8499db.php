...
<aside class="z-20 flex-shrink-0 hidden w-64 overflow-y-auto bg-white md:block" aria-label="aside">
    <div class="text-serv-bg">
        ...
        <div class="" href="#">
            <img src="<?php echo e(asset('assets/images/logo.svg')); ?>" alt="" class="object-center mx-auto my-8 ">
        </div>
        ...
        <div class="flex items-center pt-8 pl-5 space-x-2 border-t border-gray-100">
            ...
            <img class="object-cover object-center mr-1 rounded-full w-14 h-14"
                src="<?php echo e(url('https://randomuser.me/api/portraits/men/1.jpg')); ?>" alt="random user" />
            <div>
                <!--Author name-->
                <p class="font-semibold text-gray-900 text-md"><?php echo e(Auth::user()->name); ?></p>
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-medium text-gray-800 transition-colors duration-150 hover:text-gray-800 " href="<?php echo e(route('member.dashboard.index')); ?>">
        ...
        <ul>
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="<?php echo e(route('member.service.index')); ?>">
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="<?php echo e(route('member.request.index')); ?>">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="<?php echo e(route('member.order.index')); ?>">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="<?php echo e(route('member.profile.index')); ?>">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li class="relative px-6 py-3">
                <a class="inline-flex items-center w-full text-sm font-light transition-colors duration-150 hover:text-gray-800" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <rect width="24" height="24" fill="white" />
...
</aside><?php /**PATH C:\xampp\htdocs\bwa-jasa\resources\views/components/dashboard/desktop.blade.php ENDPATH**/ ?>